-- Add generation_model column to variant_rows table
...
ALTER TABLE public.variant_rows
DROP CONSTRAINT IF EXISTS variant_rows_generation_model_check;

ALTER TABLE public.variant_rows
ADD CONSTRAINT variant_rows_generation_model_check 
