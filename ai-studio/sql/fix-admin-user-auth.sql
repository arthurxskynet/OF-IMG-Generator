...
-- This script fixes the admin user if it was created incorrectly
-- Run this if you're getting 500 errors on login
...
BEGIN
  ...
  IF v_existing_user_id IS NOT NULL THEN
    RAISE NOTICE 'Found existing user with ID: %', v_existing_user_id;
    ...
    RAISE NOTICE 'Deleted existing user to recreate properly';
  END IF;
  ...
  INSERT INTO auth.users (
    ...
    '{}'::jsonb,  -- Empty jsonb - this is important!
    false,
    now(),
    now(),
    now(),
